...
## Code
Below we opensource the code for our 2D RGB experiments, soon we'll opensource the code for our pointcloud experiments.
### Installation
...
Rename the folder to `clevr_train` for debugging with this code.
...
Download, unzip and update the `root_folder` variable in the code accordingly.
